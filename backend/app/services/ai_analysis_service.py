...
"TRADER RULES (always respect these): stop loss never wider than 5-6%; never lose more than 3-4% of position value on a trade - if it goes against, cut half early and exit fully at the stop; entries near the 10/21 EMA on pullbacks, or at the pivot on orderly 2-week-plus bases.\n\n"
...
"THE STUDENT'S STATED RULES - grade them against these: stop loss never wider than 5-6%; never lose more than 3-4% on a trade; if a trade goes against them they should cut half early, full exit at the stop. Explicitly flag every trade where they risked too much, lost more than the rule allows, or failed to cut early.\n\n"
